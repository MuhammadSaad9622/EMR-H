...
const PatientList: React.FC = () => {
  ...
  const fetchPatients = async () => {
    setIsLoading(true);
    try {
      const response = await axios.get(`https://emr-h.onrender.com/api/patients?page=${currentPage}&search=${searchTerm}`);
  ...
  const deletePatient = async () => {
    try {
      await axios.delete(`https://emr-h.onrender.com/api/patients/${selectedPatient}`);
